...
//     items: [
//       { name: 'Air-Conditioning', desc: 'Climate control solutions for optimal industrial comfort', icon: '❄️', details: ['VRF/VRV System Layouts', 'Chilled Water Plant Routing', 'Cleanroom HVAC Engineering'] },
//       { name: 'Lighting Systems', desc: 'Energy-efficient illumination design', icon: '💡', details: ['Lux Level Mapping', 'Architectural Automations', 'Emergency Path Systems'] },
//       { name: 'Electrical Works', desc: 'Complete heavy electrical infrastructure', icon: '⚡', details: ['HT/LT Panel Installations', 'Transformer Placement', 'Uninterrupted Power Setups'] },
//       { name: 'Network Cabling', desc: 'Structured data & communication systems', icon: '⛫', details: ['Cat6/Fiber Optic Layouts', 'Server Rack Topologies', 'Certified Compliance Runs'] },
//       { name: 'Security Systems', desc: 'Biometric access & high-definition CCTV surveillance', icon: '🛡️', details: ['IP-Based Camera Grids', 'Access Control Locks', 'Central Monitoring Console'] },
//       { name: 'Key Management', desc: 'Electronic access control solutions', icon: '🔑', details: ['Smart Card Integration', 'Audit Trail Software', 'Fail-Safe Logic Systems'] },
//       { name: 'Fire Protection', desc: 'Safety compliance & prevention systems', icon: '🔥', details: ['Sprinkler System Engineering', 'Smoke Detector Arrays', 'Hydrant Line Frameworks'] },
//     ]
//   },
//   {
//     id: 'construction',
...
//     items: [
//       { name: 'Construction Preliminaries', desc: 'Site preparation and temporary structural works', icon: '🪖', details: ['Excavation & Shoring', 'Site Surveying & Grid Marking', 'Safety Scaffolding Towers'] },
//       { name: 'Structural Works', desc: 'Foundation, framing, and modifications to safety codes', icon: '🧱', details: ['Reinforced Concrete Casting', 'Steel Girder Assemblies', 'Load-Bearing Modifications'] },
//       { name: 'ACP Elevation', desc: 'Aluminum composite panel modern cladding installations', icon: '🥞', details: ['Weatherproof Membrane Wraps', 'Sub-Frame Matrix Alignments', 'Premium Architectural Finishes'] },
//       { name: 'Demolition Works', desc: 'Safe, controlled demolition and waste management', icon: '🔨', details: ['Structural Load Shifting', 'Debris Sorting & Clearance', 'Controlled Kinetic Impact'] },
//       { name: 'Partition Works', desc: 'Drywall, glass, and custom flexible layout partitions', icon: '📱', details: ['Acoustic Decibel Dampening', 'Toughened Glass Channels', 'Fire-Rated Wall Linings'] },
//       { name: 'Door Supply & Install', desc: 'Complete door installations and technical hardware fitting', icon: '🚪', details: ['Fire-Rated Metal Enclosures', 'Heavy-Duty Pivots', 'Panic Bar Configurations'] },
//     ]
//   },
//   {
//     id: 'finishes',
...
//     items: [
//       { name: 'Wall Finishes', desc: 'Painting, wallpaper, and premium decorative wall treatments', icon: '🖌️', details: ['Texture Coat Application', 'Anti-Bacterial Enamels', 'Precision Edge Masking'] },
//       { name: 'Floor Finishes', desc: 'Tiles, vinyl, epoxy, and specialized industrial solutions', icon: '⚃', details: ['Self-Leveling Underlayments', 'High-Gloss Epoxy Shells', 'Anti-Static ESD Tile Work'] },
//       { name: 'Ceiling Works', desc: 'False ceilings, geometric lighting integrations, and acoustics', icon: '✛', details: ['Gypsum Board Framing', 'Modular Grid Drop Formats', 'Integrated Linear Diffusers'] },
//       { name: 'Roller Blinds', desc: 'Architectural window treatments for light control', icon: '▤', details: ['Motorized Somfy Automations', 'Blackout & Solar Screens', 'U-Channel Light Enclosures'] },
//       { name: 'Plumbing & Sanitary', desc: 'Complete premium plumbing and sanitary fixture systems', icon: '🚰', details: ['Concealed Diverter Matrices', 'Pressure-Tested Line Feeds', 'Commercial Waste Venting'] },
//     ]
//   }
// ];
...
//   const [selectedService, setSelectedService] = useState<typeof serviceCategories[0]['items'][0] | null>(null);
...
//       id="services" 
//       ref={sectionRef} 
//       className="py-28 px-6 md:px-12 bg-[#ffffff] transition-colors duration-500 overflow-hidden relative"
//     >
//       {/* Background Architectural Blueprint Subtle Mesh Pattern */}
...
//         >
//           <div className="text-sm tracking-widest text-black/40 dark:text-white/40 mb-4 ">
...
//           <p className="text-zinc-500 max-w-xl text-md font-normal leading-relaxed">
...
//           {/* Premium Segment Filter Controls */}
//           <div className="w-full max-w-3xl mt-12 grid grid-cols-1 md:grid-cols-3 border border-zinc-200/80 rounded-2xl bg-white/70 backdrop-blur-md p-1.5 shadow-[0_8px_30px_rgba(0,0,0,0.02)] overflow-hidden">
...
//                   className="relative py-3.5 px-6 rounded-xl text-center transition-all duration-500 outline-none overflow-hidden group "
//                 >
//                   {isSelected && (
//                     <motion.div 
//                       layoutId="premiumTabBackground"
//                     //   className="absolute inset-0  shadow-[0_4px_20px_rgba(197,168,128,0.12)] border border-black/[0.04] z-0 rounded-xl bg-[#000000]"
//                       className="absolute inset-0  shadow-[0_4px_20px_rgba(197,168,128,0.12)] border border-black/[0.04] z-0 rounded-xl bg-[#c88323] "
//                     //   className="absolute inset-0  shadow-[0_4px_20px_rgba(197,168,128,0.12)] border border-black/[0.04] z-0 rounded-xl bg-[#c5a880] "
//                       transition={{ type: "spring", stiffness: 260, damping: 30 }}
//                     />
//                   )}
//                   <div className="relative z-10 flex flex-col items-center ">
//                     <span className={`text-sm font-bold tracking-tight transition-colors duration-300 tracking-normal ${
//                       isSelected ? 'text-white' : 'text-zinc-500 group-hover:text-zinc-800'
//                     }`}>
//                       {cat.title}
//                     </span>
//                   </div>
...
//         {/* Structured 2-Column Split Execution Grid Layout */}
//         <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          
//           {/* Column Left: Category Text Overview Block */}
...
//                 className="p-8 rounded-2xl bg-white border border-zinc-200/60 shadow-[0_10px_40px_rgba(0,0,0,0.01)]"
//               >
//                 <span className="text-[10px] tracking-widest font-mono font-bold text-[#c5a880] block mb-2">
//                   {activeTab === 'mep' ? '// ARCHITECTURE.01' : activeTab === 'construction' ? '// ARCHITECTURE.02' : '// ARCHITECTURE.03'}
//                 </span>
//                 <h3 className="text-2xl font-serif text-[#111111] mb-4 tracking-tight font-medium">
//                   {currentCategory.title}
//                 </h3>
//                 <p className="text-[13px] text-zinc-400 leading-relaxed mb-8 font-normal">
//                   {currentCategory.extendedDesc}
//                 </p>

//                 {/* Vertical Compliance Assurance Checkers */}
//                 <div className="border-t border-zinc-100 pt-6 space-y-4">
//                   <div className="flex items-center gap-3 text-xs font-semibold text-zinc-600">
//                     <span className="text-[#c5a880] text-[15px] font-bold">→</span>
//                     Licensed System Contractors
//                   </div>
//                   <div className="flex items-center gap-3 text-xs font-semibold text-zinc-600">
//                     <span className="text-[#c5a880] text-[15px] font-bold">→</span>
//                     Safety Standard Compliance Matrix
//                   </div>
//                   <div className="flex items-center gap-3 text-xs font-semibold text-zinc-600">
//                     <span className="text-[#c5a880] text-[15px] font-bold">→</span>
//                     Premium Quality Material Assured
//                   </div>
//                 </div>
//               </motion.div>
//             </AnimatePresence>
...
//           {/* Column Right: Interactive Premium White Feature Matrix Grid */}
...
//                     className="group relative bg-white border border-zinc-200/60 rounded-2xl p-6 cursor-pointer hover:border-[#c5a880]/40 hover:shadow-[0_20px_40px_rgba(197,168,128,0.04)] transition-all duration-500 flex flex-col justify-between min-h-[180px]"
//                   >
//                     <div>
//                       <div className="flex items-center justify-between mb-4">
//                         <div className="w-10 h-10 rounded-xl bg-[#c5a880]/10 text-[#c5a880] flex items-center justify-center text-lg font-bold group-hover:bg-[#c5a880] group-hover:text-white transition-all duration-500">
//                           {service.icon}
//                         </div>
//                         <span className="text-[10px] font-mono text-zinc-300 group-hover:text-[#c5a880] transition-colors duration-300">
//                           {(index + 1).toString().padStart(2, '0')} //
//                         </span>
//                       </div>

//                       <h4 className="text-base font-bold text-[#111111] tracking-tight mb-2 group-hover:text-[#c5a880] transition-colors duration-300">
//                         {service.name}
//                       </h4>
//                       <p className="text-xs text-zinc-400 font-normal leading-relaxed pr-2">
//                         {service.desc}
//                       </p>
//                     </div>

//                     <div className="flex items-center gap-1.5 mt-6 opacity-0 group-hover:opacity-100 transform translate-x-[-4px] group-hover:translate-x-0 transition-all duration-300">
//                       <span className="text-[10px] tracking-widest font-bold uppercase text-[#c5a880]">View Protocols</span>
...
//       {/* Light Luxury Translucent Deep Specs Overlay Drawer */}
//       <AnimatePresence>
//         {selectedService && (
//           <motion.div
//             className="fixed inset-0 bg-black/20 z-50 flex items-center justify-end backdrop-blur-md"
//             initial={{ opacity: 0 }}
//             animate={{ opacity: 1 }}
//             exit={{ opacity: 0 }}
...
//           >
//             <motion.div
//               className="w-full max-w-lg h-full bg-white border-l border-zinc-200 p-8 md:p-12 flex flex-col justify-between shadow-2xl relative"
//               initial={{ x: '100%' }}
//               animate={{ x: 0 }}
//               exit={{ x: '100%' }}
...
//                   <div className="text-[10px] font-mono font-bold tracking-[0.2em] text-[#c5a880] uppercase">
//                     TECHNICAL ARCHITECTURE
//                   </div>
//                   <button
//                     onClick={() => setSelectedService(null)}
//                     className="text-xs tracking-widest font-mono text-zinc-400 hover:text-black transition-colors"
//                   >
//                     CLOSE // ✕
//                   </button>
//                 </div>

//                 <div className="w-12 h-12 rounded-xl bg-zinc-50 border border-zinc-100 flex items-center justify-center text-xl mb-6">
//                   {selectedService.icon}
//                 </div>

//                 <h3 className="text-2xl font-serif text-[#111111] tracking-tight mb-3 font-medium">
...
//                 <h4 className="text-[10px] font-mono font-bold tracking-widest uppercase text-zinc-400 mb-4">
...
//                     <div 
//                       key={idx}
//                       className="p-3.5 rounded-xl bg-[#faf9f6] border border-zinc-200/40 flex items-center justify-between"
//                     >
//                       <span className="text-xs font-semibold text-zinc-700">{detail}</span>
//                       <span className="text-[9px] font-mono font-bold text-[#c5a880] bg-[#c5a880]/10 px-2 py-0.5 rounded-md">CERTIFIED</span>
//                     </div>
//                   ))}
//                 </div>
//               </div>

//               <div className="pt-6 border-t border-zinc-100 flex items-center justify-between text-[10px] font-mono text-zinc-400">
...
//       id="services" 
//       ref={sectionRef} 
//       className="py-28 px-6 md:px-12 bg-[#ffffff] transition-colors duration-500 overflow-hidden relative font-sans"
//     >
//       {/* Background Architectural Blueprint Subtle Mesh Pattern */}
//       <div className="absolute inset-0 bg-[linear-gradient(to_right,#c5a88008_1px,transparent_1px),linear-gradient(to_bottom,#c5a88008_1px,transparent_1px)] bg-[size:50px_50px] pointer-events-none" />
...
//           transition={{ duration: 0.8, ease: [0.25, 1, 0.5, 1] }}
//         >
//           <div className="text-sm tracking-widest text-black/40 dark:text-white/40 mb-4 font-sans">
//             TECHNICAL CAPABILITIES
//           </div>
//           <h2 className="text-4xl md:text-5xl mb-4 dark:text-white font-sans tracking-tight font-bold">
//             Our Architectural Frameworks
//           </h2>
//           <div className="w-16 h-[2px] bg-[#c5a880] mb-8" />
//           <p className="text-zinc-500 max-w-xl text-md font-normal leading-relaxed font-sans">
//             Industrial engineering benchmarks paired with design precision. Select a discipline below to filter our structural core solutions.
//           </p>

//           {/* Premium Segment Filter Controls */}
//           <div className="w-full max-w-3xl mt-12 grid grid-cols-1 md:grid-cols-3 border border-zinc-200/80 rounded-2xl bg-white/70 backdrop-blur-md p-1.5 shadow-[0_8px_30px_rgba(0,0,0,0.02)] overflow-hidden font-sans">
//             {serviceCategories.map((cat) => {
//               const isSelected = activeTab === cat.id;
//               return (
//                 <button
...
//                 exit={{ opacity: 0, x: -10 }}
//                 transition={{ duration: 0.5, ease: [0.25, 1, 0.5, 1] }}
//                 className="p-8 rounded-2xl bg-white border border-zinc-200/60 shadow-[0_10px_40px_rgba(0,0,0,0.01)] font-sans"
//               >
//                 <span className="text-[12px] tracking-widest font-mono font-bold text-[#c5a880] block mb-2">
//                   {activeTab === 'mep' ? '01. ARCHITECTURE' : activeTab === 'construction' ? '02. ARCHITECTURE' : '03. ARCHITECTURE'}
//                 </span>
//                 <h3 className="text-2xl mb-4 tracking-tight font-bold text-[#111111] font-sans">
//                   {currentCategory.title}
//                 </h3>
//                 <p className="text-[13px] text-zinc-400 leading-relaxed mb-8 font-normal font-sans">
//                   {currentCategory.extendedDesc}
//                 </p>

//                 {/* Vertical Compliance Assurance Checkers */}
//                 <div className="border-t border-zinc-100 pt-6 space-y-4 font-sans">
//                   <div className="flex items-center gap-3 text-xs font-semibold text-zinc-600 font-sans">
//                     <span className="text-[#c5a880] text-[15px] font-bold">→</span>
//                     Licensed System Contractors
//                   </div>
//                   <div className="flex items-center gap-3 text-xs font-semibold text-zinc-600 font-sans">
...
//                     key={service.name}
//                     onClick={() => setSelectedService(service)}
//                     className="group relative bg-white border border-zinc-200/60 rounded-2xl p-6 cursor-pointer hover:border-[#c5a880]/40 hover:shadow-[0_20px_40px_rgba(197,168,128,0.04)] transition-all duration-500 flex flex-col justify-between min-h-[180px] font-sans"
//                   >
//                     <div className="font-sans">
//                       <div className="flex items-center justify-between mb-4 font-sans">
//                         <div className="w-10 h-10 rounded-xl bg-[#c5a880]/10 text-[#c5a880] flex items-center justify-center text-lg font-bold group-hover:bg-[#c5a880] group-hover:text-white transition-all duration-500 font-sans">
//                           {service.icon}
//                         </div>
//                         <span className="text-[10px] font-mono text-zinc-300 group-hover:text-[#c5a880] transition-colors duration-300">
//                           {(index + 1).toString().padStart(2, '0')} //
...
//                       <h4 className="text-base font-bold text-[#111111] tracking-tight mb-2 group-hover:text-[#c5a880] transition-colors duration-300 font-sans">
//                         {service.name}
//                       </h4>
//                       <p className="text-xs text-zinc-400 font-normal leading-relaxed pr-2 font-sans">
//                         {service.desc}
//                       </p>
//                     </div>

//                     <div className="flex items-center gap-1.5 mt-6 opacity-0 group-hover:opacity-100 transform translate-x-[-4px] group-hover:translate-x-0 transition-all duration-300 font-sans">
//                       <span className="text-[10px] tracking-widest font-bold uppercase text-[#c5a880] font-sans">View Protocols</span>
//                       <span className="text-[#c5a880] text-xs">→</span>
//                     </div>
//                   </div>
//                 ))}
...
//         {selectedService && (
//           <motion.div
//             className="fixed inset-0 bg-black/20 z-50 flex items-center justify-end backdrop-blur-md font-sans"
//             initial={{ opacity: 0 }}
//             animate={{ opacity: 1 }}
//             exit={{ opacity: 0 }}
//             onClick={() => setSelectedService(null)}
//           >
//             <motion.div
//               className="w-full max-w-lg h-full bg-white border-l border-zinc-200 p-8 md:p-12 flex flex-col justify-between shadow-2xl relative font-sans"
//               initial={{ x: '100%' }}
//               animate={{ x: 0 }}
//               exit={{ x: '100%' }}
//               transition={{ type: 'spring', damping: 32, stiffness: 220 }}
...
//                 <div className="w-12 h-12 rounded-xl bg-zinc-50 border border-zinc-100 flex items-center justify-center text-xl mb-6 font-sans">
//                   {selectedService.icon}
//                 </div>

//                 <h3 className="text-2xl text-[#111111] tracking-tight mb-3 font-bold font-sans">
//                   {selectedService.name}
//                 </h3>
//                 <p className="text-xs text-zinc-400 font-light leading-relaxed mb-8 font-sans">
//                   {selectedService.desc}
//                 </p>
...
//                     <div 
//                       key={idx}
//                       className="p-3.5 rounded-xl bg-[#faf9f6] border border-zinc-200/40 flex items-center justify-between font-sans"
//                     >
//                       <span className="text-xs font-semibold text-zinc-700 font-sans">{detail}</span>
//                       <span className="text-[9px] font-mono font-bold text-[#c5a880] bg-[#c5a880]/10 px-2 py-0.5 rounded-md">CERTIFIED</span>
//                     </div>
//                   ))}
//                 </div>
