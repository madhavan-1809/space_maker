...
// import { Home, Building2, Box, Wrench, Factory } from 'lucide-react';
...
//     icon: Wrench,
//     title: 'Renovation',
//     description: 'Expert transformation of existing spaces with minimal disruption and maximum impact.',
//   },
// ];
...
//   return (
//     <div id="services" ref={sectionRef} className="py-32 px-6 bg-[#fafaf8] dark:bg-[#111111]">
...
//         >
//           <div className="text-sm tracking-widest text-black/40 dark:text-white/40 mb-4">OUR PROCESS</div>
//           <h2 className="text-4xl md:text-5xl mb-4 dark:text-white">How We Work</h2>
...
//             <motion.div
//               key={service.title}
//               className="group relative bg-white dark:bg-black p-8 hover:shadow-xl transition-all duration-500 cursor-pointer"
//               initial={{ opacity: 0, y: 30 }}
//               animate={isVisible ? { opacity: 1, y: 0 } : {}}
//               transition={{ duration: 0.6, delay: index * 0.1 }}
//             >
//               <div className="absolute top-0 left-0 w-0 h-px bg-black/20 dark:bg-white/20 group-hover:w-full transition-all duration-500" />
//               <div className="absolute bottom-0 right-0 w-0 h-px bg-black/20 dark:bg-white/20 group-hover:w-full transition-all duration-500" />
//               <div className="absolute top-0 left-0 h-0 w-px bg-black/20 dark:bg-white/20 group-hover:h-full transition-all duration-500" />
//               <div className="absolute bottom-0 right-0 h-0 w-px bg-black/20 dark:bg-white/20 group-hover:h-full transition-all duration-500" />

//               <div className="mb-6 group-hover:scale-110 transition-transform duration-500">
//                 <service.icon size={40} strokeWidth={1.5} className="text-black dark:text-white" />
//               </div>
//               <h3 className="text-xl mb-3 dark:text-white">{service.title}</h3>
//               <p className="text-black/60 dark:text-white/60 leading-relaxed">{service.description}</p>
//             </motion.div>
//           ))}
//         </div>
//       </div>
...
// export function Process() {
//   const [isVisible, setIsVisible] = useState(false);
//   // activePhase: 0 means normal entrance, 1 means Step 1 highlighted, 2 means Step 1 & 2 highlighted... up to 5, then resets to 1.
...
//     // Start the sequential looping sequence after the entrance animation finishes (~2.5 seconds)
...
//       setActivePhase((prev) => {
//         // If we reached the final step (5), wait a cycle and reset back to Step 1 highlighted
//         if (prev >= processSteps.length) {
//           return 1;
//         }
//         return prev + 1;
//       });
//     }, 1000); // Amount of time each step remains highlighted solo before advancing the chain
...
//             // Evaluates if this specific step should show its highlight/hover properties 
...
//                   {/* Expanding Outer Glow Loop on Hover / Loop Flow */}
//                   <div 
...
//                   {/* Minimalist Numeric Node Circle */}
//                   <div 
...
//                   }`}
//                 >
//                   {/* Modern Context Number + Title Combination */}
//                   <h3 className="text-xl font-medium tracking-wide text-white mb-4 relative inline-block">
//                     {step.title}
//                     {/* Micro underline indicator that grows outward dynamically */}
//                     <span 
